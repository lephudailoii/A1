...
public class cauhoiadapter extends ArrayAdapter<cauhoi> {
    ...
    public cauhoiadapter(@NonNull Context context, int resource, @NonNull ArrayList<cauhoi> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView cautraloi=convertView.findViewById(R.id.cautraloi);
        ...
        cautraloi.setText(cauhoiii.getDapan());
        stt.setText(cauhoiii.getStt());
        return convertView;
    }
}
